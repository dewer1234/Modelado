...
public class Menu extends JFrame   {
   ...
   private String archivo2 = "clientes.ser";
   ...
   public void ponPestaniaAgregar() {
      ...
      panelFichas.addTab( "Agregar Producto", panel1);
   }
   ...
   public ArrayList leerUsuarios(){
      try{
         ObjectInputStream lector=new ObjectInputStream(new FileInputStream(archivo2));
         ArrayList<Cliente> usuarios = (ArrayList<Cliente>) lector.readObject();
         lector.close();
         this.users=usuarios;
      }
      catch(IOException e){
 ...
 public void ponPestaniaAgregarUsuario() {

      Icon imagen = new ImageIcon(  "usuario.jpg"  );
      JLabel estampa = new JLabel(imagen);      
      //Etiquetas de los mensajes
      JLabel label0 = new JLabel("Rellena la siguiente información");
      ...
      JTextField paterno = new JTextField(); //apellido paterno
      JTextField materno = new JTextField(); //apellido materno
      ...
      JPanel panel_2 = new JPanel(new GridLayout(7,2,-100,30));
      panel_2.add(label0);
      ...
      boton_registro.addActionListener(new ActionListener() {             
         public void actionPerformed(ActionEvent evento) {                                   
            ...
            String dad =paterno.getText();
            String mom = materno.getText();
            String log = login.getText();
            String con = contrasena.getText();
            
            boolean se_pudo = agregaCliente(name, dad, mom, log, con);
            if(se_pudo) {
               JOptionPane.showMessageDialog(null, "Cliente agregado exitosamente ", "exito", JOptionPane.INFORMATION_MESSAGE);
            } else {
               JOptionPane.showMessageDialog(null, "ocurrio un error ", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
         }                       
      });                                     
      panelFichas.addTab( "Agregar Usuario", panel2);
   }

public boolean agregaCliente(String n, String ap, String am, String login, String c) {
   Cliente nuevo = new Cliente(n, ap, am, login, c);
   users.add(nuevo);
   return true;
   }
 ...
 public void grabar2(){
      try{
         ObjectOutputStream a= new ObjectOutputStream(new FileOutputStream(archivo2));
         a.writeObject(users);
         a.close();
      }
      catch(NotSerializableException e){
